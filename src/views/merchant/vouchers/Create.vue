<script setup>
// filepath: /var/www/html/KMI-SIMSLIFE-FE/src/views/merchant/vouchers/Create.vue
...
const fetchMerchantItems = async () => {
  ...
  try {
    ...
    if (isDev) {
      console.error("[CreateVoucher] Error fetching merchant items:", err);
    }
  } finally {
    ...
    <div class="px-4 pt-4 mx-auto sm:px-6 sm:py-6 sm:pt-0">
        ...
        <div class="flex gap-3">
          ...
          <div class="flex-1">
            ...
            <ul class="pl-4 space-y-1 text-xs list-disc text-merchant-primary">
              ...
              <li>
                Anda dapat membatasi voucher untuk berlaku pada seluruh produk atau produk tertentu saja.
              </li>
      ...
      <Form @submit="onSubmit">
        ...
        >
          ...
          <!-- Item Selector Panel (Visible when applies_to === 'specific') -->
          <div
            v-if="applies_to === 'specific'"
