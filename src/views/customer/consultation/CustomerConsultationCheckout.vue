...
const isHomeService = computed(() => ['ke_rumah_pelanggan', 'ke_tempat_pelanggan', 'on_site', 'customer_location'].includes(getServiceType()));
const isMerchantPlaceService = computed(() => ['di_tempat_umkm', 'ditempat_umkm', 'at_location', 'at_merchant'].includes(getServiceType()));
